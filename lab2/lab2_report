...
* подготовлена схема связи, отражающая взаимодействие трёх филиалов;
...
В ходе лабораторной работы была успешно реализована модель распределённой корпоративной сети связи. Были настроены три маршрутизатора, объединяющие московский, франкфуртский и берлинский филиалы компании, выполнено планирование IP-адресации, настроены DHCP-серверы для клиентских устройств и реализована статическая маршрутизация между филиалами.
